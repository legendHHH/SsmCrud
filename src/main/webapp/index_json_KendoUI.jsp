...
<head>
    ...
    <%--引入KendoUI类库--%>
    <script src="${pageContext.request.contextPath}/static/KendoUI/js/kendo.all.min.js"></script>
            ...
            <div class="modal-body">
                ...
                <form class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="email" class="form-control" data-bind="value:email_update_value" id="email_update_input" placeholder="email@qq.com">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10" id="g_input">
                            <label class="radio-inline">
                                <input type="radio" name="gender" id="gender1_update_input" value="M" data-bind="checked:genders"> 男
                            </label>
                            <label class="radio-inline">
                                <input type="radio" name="gender" id="gender2_update_input" value="F" data-bind="checked:genders"> 女
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4" id="sel">

                            <!--KendoUI 数据绑定部门-->
                            <select data-bind="source:depts,value:deptId" data-template="dept-template" class="form-control" id="dept_update_select" name="dId">
                                <!--动态加载部门-->
                                <%--<option>1</option>
                                <option>2</option>
                                <option>3</option>
            ...
            <div class="modal-body">
                ...
                <form class="form-horizontal">
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label">Department</label>
                        <div class="col-sm-4">
                            <select data-bind="source:depts" data-template="dept-template" class="form-control" id="dept_add_select" name="dId">
                                <!--动态加载部门-->
                                <%--<option>1</option>
                                <option>2</option>
                                <option>3</option>
    ...
    <div class="row">
        <div class="col-md-12">
            <table class="table table-hover" id="emps_table">
                ...
                <tbody data-template="emps-template" data-bind="source: emps">
...
<script type="text/javascript">
    ...
    function build_emps_table(result) {
        ...
        //使用KendoUI模板
        var empsViewModel = kendo.observable({
            emps:emps,
        });
        kendo.bind($("#emps_table tbody"),empsViewModel);
    ...
    function getDepts(ele) {
        ...
        $.ajax({
            ...
            success:function (result) {
                ...
                //替换KendoUI
                var viewDept = kendo.observable({
                    depts:result.extend.depts,
                });
                kendo.bind($(ele),viewDept);
        ...
        $.ajax({
            ...
            success:function (result) {
                ...
                var viewModelUpdate = kendo.observable({
                    email_update_value:result.extend.emp.email,
                });
                kendo.bind($("#email_update_input"),viewModelUpdate);

                var viewModelGender = kendo.observable({
                    genders:result.extend.emp.gender,
                });
                kendo.bind($("#g_input input"),viewModelGender);

                var viewModelDeptId = kendo.observable({
                    deptId:result.extend.emp.department.deptId,
                });
                kendo.bind($("#dept_update_select"),viewModelDeptId);
...
<!--部门编号数据模板-->
<script id="dept-template" type="text/x-kendo-template">
    <option value="#=deptId#">#=deptName#</option>
</script>


<!--表格数据的创建-->
<script id="emps-template" type="text/x-kendo-template">
    <tr>
        ...
        <td>
            <button class="btn btn-primary btn-sm edit_btn" edit_id="#=empId#">
                <span class="glyphicon glyphicon-pencil">编辑</span>
            </button>

            <button class="btn btn-danger btn-sm delete_btn" del_id="#=empId#">
